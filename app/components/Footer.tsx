            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex gap-8 flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="text-center md:text-left mb-4 md:mb-0">
                        <h2 className="text-xl font-semibold mb-2 font-cuba">Contact me</h2>
                        <div className="mb-2 flex justify-center md:justify-start gap-3 items-center">
                            <MdOutlineEmail />
                            <a
                        ...
                        <div className="mb-2 justify-center md:justify-start flex gap-3 items-center">
                            <MdLocalPhone />
                            <a
                ...
                <p className="mt-3 text-center md:text-start text-neutral-600">
